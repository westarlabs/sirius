...
import org.starcoin.sirius.serialization.BinaryTaggedDecoder
import org.starcoin.sirius.serialization.BinaryTaggedEncoder
import org.starcoin.sirius.serialization.protobuf.ProtoBuf.Varint.decodeSignedVarintInt
import org.starcoin.sirius.serialization.protobuf.ProtoBuf.Varint.decodeSignedVarintLong
import org.starcoin.sirius.serialization.protobuf.ProtoBuf.Varint.decodeVarint
import org.starcoin.sirius.serialization.protobuf.ProtoBuf.Varint.encodeVarint

class ProtoBuf : AbstractSerialFormat(), BinaryFormat {

    internal open inner class ProtobufWriter(val encoder: ProtobufEncoder) : BinaryTaggedEncoder<ProtoDesc>() {
    ...
    private open inner class ProtobufReader(val decoder: ProtobufDecoder) : BinaryTaggedDecoder<ProtoDesc>() {
        ...
        override fun decodeTaggedEnum(tag: ProtoDesc, enumDescription: EnumDescriptor): Int = decoder.nextInt(
